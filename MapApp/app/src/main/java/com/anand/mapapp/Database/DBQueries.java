...
public class DBQueries {
    ...
    class Employeeinsertiontask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            empList.add(em);
            em = new Employee(3,"Anand Jaykumar",  2, 4,R.drawable.flag, "Intern", "anandjayakumar18@gmail.com",0);
            empList.add(em);
            em = new Employee(4,"Elizabeth George",  3, 1,R.drawable.flag, "Designer", "elizabethgeorge94@gmail.com",0);
            empList.add(em);
            em = new Employee(5,"Goutham Krishna",  4, 3,R.drawable.flag, "Intern", "gouthamkrishna.mr@gmail.com",0);
            empList.add(em);
            em = new Employee(6,"Jithin V",  1, 2,R.drawable.flag, "Architect","jithinsrk14@gmail.com",0);
            empList.add(em);
    ...
    class Placeinsertiontask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            pl = new Place(1,"Meeting Room 1",1,3,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(2,"Meeting Room 2",3,2,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(3,"Meeting Room 3",5,2,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(4,"Toilet (Ladies)",2,3,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(5,"Toilet (Gents)",2,3,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(6,"Entry 1", 4, 3, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(7,"Entry 2", 5, 4, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(8,"Exit 1", 1, 4, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(9,"Exit 2", 2, 4, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(10,"Beverages 1",2,1,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(11,"Beverages 2",5,1,R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(12,"Server", 3, 3, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(13,"Eatery 1", 3, 3, R.drawable.ic_eatery,0);
            placeList.add(pl);
            pl = new Place(14,"Eatery 2", 3, 3, R.drawable.ic_eatery,0);
            placeList.add(pl);
