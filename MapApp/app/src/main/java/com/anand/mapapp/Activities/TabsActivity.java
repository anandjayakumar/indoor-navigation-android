    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mytabs.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String tabId) {
                ...
                switch (index) {
                    case 0:
                        tv1.setTextColor(Color.parseColor("#E4E379"));
                        line1.setVisibility(View.VISIBLE);
                        tv2.setTextColor(Color.parseColor("#8DBCF4"));
                        line2.setVisibility(View.GONE);
                        break;
                    case 1:
                        tv1.setTextColor(Color.parseColor("#8DBCF4"));
                        line1.setVisibility(View.GONE);
                        tv2.setTextColor(Color.parseColor("#E4E379"));
